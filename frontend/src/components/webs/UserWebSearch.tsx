...
function UserWebSearch() {
  ...
  return (
    ...
    >
      ...
      {isSearchActive && (
        <div className="absolute top-full border z-50 mt-2 md:w-[200px] lg:w-full max-h-[400px] rounded-lg border bg-background p-2 shadow-lg overflow-y-scroll no-scrollbar">
