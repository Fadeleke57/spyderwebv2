...
const PrivacyPolicy: React.FC = () => {
  return (
    <div className="p-6 lg:px-10 py-24">
      ...
      <ul>
        <li>
          ...
          identify you, such as your name, email address, and login credentials.
        </li>
        <li>
          <strong>Usage Data</strong>: Information on how you access and use the
          app, including your interactions, preferences, and any data related to
      ...
      <ul>
        <li>
          <strong>To provide and maintain our service</strong>: Ensuring the app
          functions as intended and improving user experience.
        </li>
        <li>
      ...
      <ul>
        <li>
          ...
          third-party service providers who assist us in operating our app, such
          as hosting, data analysis, and customer service.
        </li>
        <li>
      ...
      <p>
        ...
        security system is impenetrable, and we cannot guarantee the security of
        our databases.
      </p>
      ...
      <ul>
        ...
        <li>
          <strong>Objection to Processing</strong>: You have the right to object
          to our processing of your personal data.
        </li>
        <li>
          <strong>Data Portability</strong>: You have the right to request that
          we transfer your data to another organization or directly to you.
        </li>
      </ul>
      <p>
      ...
      <p>
        ...
        13, we will take steps to delete that information from our servers.
      </p>
